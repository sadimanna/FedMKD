...
class BaseDataset(object):
    ...
    def get_setting_folder(dataset, split_type, num_of_client, min_size, class_per_client,
                           fraction, iid_fraction, user_str, train_test_split, public, alpha=None, weights=None):
        if dataset == CIFAR10 or dataset == CIFAR100:
            # add small for small public dataset
            if public == "iid":
                return "{}_{}_{}_{}_{}_{}_{}_iid".format(dataset, split_type, num_of_client, min_size,
                                                           class_per_client, alpha,
                                                           1 if weights else 0)
            elif public == "class":
                return "{}_{}_{}_{}_{}_{}_{}_class".format(dataset, split_type, num_of_client, min_size, class_per_client, alpha,
                                                 1 if weights else 0)
        else:
