...
class Cifar10(BaseDataset):
    def __init__(self,
        ...
        super(Cifar10, self).__init__(root,
                                      ...
                                      setting_folder,
                                      seed)
        self.train_data, self.test_data, self.public_data = {}, {}, {}
    ...
    def preprocess(self):
        ...
        public_data_path = os.path.join(self.data_folder, "public") # ADD
        ...
        _, train_data, public_data = data_simulation(self.train_data['x'],
                                        self.train_data['y'],
                                        self.num_of_client,
                                        self.split_type,
                                        self.weights,
